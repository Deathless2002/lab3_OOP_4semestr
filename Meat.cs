...
namespace OOP3
{
    public class Meat : Main_dish
    {
        ...
        public override void ShowInList(DataGridView dgv)
        {
            ...
            dgv.Rows.Add(this.Type, this.Name, price, this.Weight, "", "", this.Garnish.ToString(), this.TypeOfMeat, "", "", "");
        }
        ...
        public override void ShowForEditEdition(Form2 Form2)
        {
            ...
            Form2.tbUnique.Text = this.TypeOfMeat;
            if (this.Garnish)
            {
        ...
        public override void Edit(Form2 Form2)
        {
            ...
            this.TypeOfMeat = Form2.tbUnique.Text;
